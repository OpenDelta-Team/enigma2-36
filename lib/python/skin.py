...
DEFAULT_SKIN = BoxInfo.getItem("HasFullHDSkinSupport") and "areadeltasat-fhd/skin.xml" or "delta-dark-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
